...
export type SoundType = 'newOrder' | 'newReservation' | 'orderReady' | 'kdsNewOrder' | 'maxWaitAlert' | 'tableWaitAlert' | 'idleTableAlert' | 'orderCancelled' | 'bottleneckAlert' | 'stationChange';
