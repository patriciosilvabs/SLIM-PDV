...
export default function PlatformSubscriptions() {
  return (
    <RequirePlatformAdmin>
      <PlatformSubscriptionsContent />
    </RequirePlatformAdmin>
  );
}

function PlatformSubscriptionsContent() {
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Prox. Cobranca</TableHead>
                          ...
                          <div>
                            ...
                            {(sub.subscription_plans as any)?.price_monthly && (
                              <p className="text-xs text-muted-foreground">
                                R$ {((sub.subscription_plans as any).price_monthly / 100).toFixed(2)}/mes
                              </p>
                            )}
                          </div>
                        </TableCell>
